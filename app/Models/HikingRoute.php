...
class HikingRoute extends Model
{
    ...
    protected $fillable = [
        ...
        'natural_springs', 'cai_huts', 'has_natural_springs', 'has_cai_huts', 'cached_mitur_api_data'
    ];
    ...
    public static array $info_fields = [
        ...
        'other' => [
            ...
            'note_it' => ['type' => 'string', 'comp' => false, 'label' => 'Note (IT)'],
            'note' => ['type' => 'string', 'comp' => false, 'label' => 'Note (EN)'],
