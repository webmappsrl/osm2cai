...
>
    ...
    class="mt-4 w-full btn btn-default btn-primary hover:bg-primary-dark"
    href="/nova/cas-login"
    >
   ...
   ">
    ...
    <div style="
    background-image: url(https://i0.wp.com/www.cai.mo.it/wp-content/uploads/2016/09/Logo-CAI-trasparente.png);
    height: 30px;
